  ...
  <div class="px-6 pt-6 2xl:container">
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <div class="md:col-span-2 lg:col-span-1">
        <div
          class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 from-indigo-100 via-blue-200 to-indigo-400 bg-gradient-to-br hover:scale-105 duration-500 cursor-pointer">
          ...
          <div>
            <h5 class="text-xl text-gray-600 text-center">整体情况</h5>
            ...
            <span class="block text-center text-gray-500 mt-2">和上周对比 ￥13,988</span>
          </div>
      ...
      <div>
        <div
          class="h-full py-6 px-6 rounded-xl border border-gray-200 from-indigo-100 via-purple-200 to-indigo-300 bg-gradient-to-br">
          <h5 class="text-xl text-gray-700">下载</h5>
          <div class="my-8">
            <h1 class="text-5xl font-bold text-gray-800">64.5%</h1>
            <span class="text-gray-500 mt-2">和上周对比 ￥13,988</span>
          </div>
      ...
      <div>
        <div
          class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 from-blue-100 via-cyan-200 to-blue-400 bg-gradient-to-br">
          ...
          <div class="mt-6">
            <h5 class="text-xl text-gray-700 text-center">个性化定制</h5>
            <div class="mt-2 flex justify-center gap-4">
            ...
            <span class="block text-center text-gray-500 mt-2">和上周对比 13</span>
          </div>
          <table class="mt-6 -mb-2 w-full text-gray-600">
            <tbody>
              <tr>
